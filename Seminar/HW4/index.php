...
$work = [
    ...
    [
        'name_prof' => 'Web Developer / something.com',
    ...
    [
        'name_prof' => 'Graphic Designer / designsomething.com',
                    ...
                    <?php for ($i = 0; $i < count($work); $i++): ?>
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b>
                                    <?php echo $work[$i]['name_prof']; ?>
                                </b></h5>
                            <?php if ($i == 0): ?>
                                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                    <?php echo $work[$i]['date']; ?> - <span class="w3-tag w3-teal w3-round">Current</span>
                                </h6>
                            <?php else: ?>
                                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                    <?php echo $work[$i]['date']; ?>
                                </h6>
                            <?php endif; ?>
                            <p>
                                <?php echo $work[$i]['description']; ?>
                            </p>
                            <hr>
                        </div>
                    <?php endfor; ?>
